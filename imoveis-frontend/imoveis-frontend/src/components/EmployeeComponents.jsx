...
function saveOrUpdatEmployee(e){
  e.preventDefault();
...
function validateForn(){
  ...
  errorsCopy.firstName = 'The first name is requirid'
  valid = false
 }
 ...
 if(lastName.trim()){
  ...
  errorsCopy.lastName = 'The last name is requirid'
   valid = false
  }
  if(email.trim()){
      errorsCopy.email = '';
          }else{
      errorsCopy.email = 'The Email is requirid'
       valid = false
      }
          ...
          <div className="card-body">
            <form className="">
              <div className="form-group mb-2">
                ...
                <input type='text' placeholder='Enter Employee First Name' name='fisrtName' 
              ...
              <button className='btn btn-success' onClick={saveOrUpdatEmployee}>Submit</button>
            </form>
          </div>
        </div>
